...
template <typename ValueType>
inline void LinkedList<ValueType>::initialize() {
    this->_size = 0;
    this->_front = nullptr;
...
template <typename ValueType>
inline LinkedList<ValueType>::LinkedList(LinkedList &other) {
    initialize();
...
template <typename ValueType>
inline LinkedList<ValueType>::LinkedList(ValueType *otherBegin, ValueType *otherEnd) {
    initialize();
...
template <typename ValueType>
inline LinkedList<ValueType>::LinkedList(ValueType initialValue) {
    initialize();
...
template <typename ValueType>
inline void LinkedList<ValueType>::print() {
...
template <typename ValueType>
inline unsigned int LinkedList<ValueType>::size() {
    return _size;
}

template <typename ValueType>
inline Node<ValueType> *LinkedList<ValueType>::front() {
    return _front;
}

template <typename ValueType>
inline Node<ValueType> *LinkedList<ValueType>::rear() {
    return _rear;
}

template <typename ValueType>
inline int LinkedList<ValueType>::find(ValueType value) {
    Node<ValueType> * currentNode = this->front();
...
template <typename ValueType>
inline void LinkedList<ValueType>::setAt(int location, ValueType newValue) {
    if (location == 0){
...
template <typename ValueType>
inline void LinkedList<ValueType>::setFront(ValueType value) {
    this->_front->setValue(value);
}

template <typename ValueType>
inline void LinkedList<ValueType>::setRear(ValueType value) {
    this->_rear->setValue(value);
}

template <typename ValueType>
inline void LinkedList<ValueType>::pushAt(int location, ValueType value) {
    if (location == 0){
...
template <typename ValueType>
inline void LinkedList<ValueType>::pushFront(ValueType value) {
    Node<ValueType> * prevNode = this->_front;
    Node<ValueType> * newNode = new Node<ValueType>(value);
    Node<ValueType> * nextNode = prevNode->next();
...
template <typename ValueType>
inline void LinkedList<ValueType>::pushRear(ValueType value) {
...
template <typename ValueType>
inline ValueType LinkedList<ValueType>::popAt(int location) {
    if (location == 0)
...
template <typename ValueType>
inline ValueType LinkedList<ValueType>::popFront() {
...
template <typename ValueType>
inline ValueType LinkedList<ValueType>::popRear() {
    Node<ValueType> * prevNode = this->_front;
